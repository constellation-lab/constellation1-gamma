...
export interface CdtTokenReadOnlyInterface {
  ...
  votingPower: ({ address }: { address: string }) => Promise<VotingPowerResponse>;
}

export class CdtTokenQueryClient implements CdtTokenReadOnlyInterface {
  ...
  votingPower = async ({ address }: { address: string }): Promise<VotingPowerResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
...
export interface CdtTokenInterface extends CdtTokenReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class CdtTokenClient extends CdtTokenQueryClient implements CdtTokenInterface {
