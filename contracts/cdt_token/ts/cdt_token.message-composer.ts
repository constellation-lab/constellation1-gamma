...
import { ExecuteMsg, Uint128, Binary } from "./cdt_token.types";

export interface CdtTokenMessageComposer {
  sender: string;
...
export class CdtTokenMessageComposer implements CdtTokenMessageComposer {
  sender: string;
  contractAddress: string;
