...
export interface CnsteTokenReadOnlyInterface {
  ...
  stakeInfo: ({ address }: { address: string }) => Promise<StakeInfo>;
}

export class CnsteTokenQueryClient implements CnsteTokenReadOnlyInterface {
  ...
  stakeInfo = async ({ address }: { address: string }): Promise<StakeInfo> => {
    return this.client.queryContractSmart(this.contractAddress, {
      stake_info: { address },
    });
  };
...
export interface CnsteTokenInterface extends CnsteTokenReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class CnsteTokenClient extends CnsteTokenQueryClient implements CnsteTokenInterface {
