...
import { ExecuteMsg, Uint128, Binary, Expiration } from "./cpst_token.types";

export interface CpstTokenMessageComposer {
  sender: string;
...
export class CpstTokenMessageComposer implements CpstTokenMessageComposer {
  sender: string;
  contractAddress: string;
