...
export interface ConsteallationReadOnlyInterface {
...
export class ConsteallationQueryClient implements ConsteallationReadOnlyInterface {
...
export interface ConsteallationInterface extends ConsteallationReadOnlyInterface {
  contractAddress: string;
  sender: string;
  create: ({
    counterOffer,
...
export class ConsteallationClient extends ConsteallationQueryClient implements ConsteallationInterface {
