...
export const CreateOption = () => {
  ...
  return (
    <Stack spacing={6} w="full" p={{ base: 4, sm: 6 }}>
      <Box alignSelf="end">
      <Tooltip label="Set the expiration time of your options here, this will determine its duration - remember to connect your wallet first." > Duration Setting</Tooltip>
      ...
      <ToToken 
        ...
        toItem={toItem} 
        setToItem={setToItem} 
        tokenCountofferValue={tokenCountofferValue} // Add this line
        setTokenCountofferValue={setTokenCountofferValue} // Update this line
